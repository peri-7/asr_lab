# run in usc/data/local/dict

import re

#######################################<3
# silence_phones.txt , optional_silence.txt prepped
with open('./silence_phones.txt', 'w') as file:
    file.write('sil\n')
with open('./optional_silence.txt', 'w') as file:
    file.write('sil\n')
...
phonemes = []
with open('./word_lex.txt', 'r') as file:
    for line in file:
